...
.results { display: grid; gap: 10px; }.result-card { position: relative; border: 1px solid #dce5dd; border-radius: 9px; background: white; transition: .18s ease; }.result-card:hover { transform: translateY(-1px); border-color: #abc0b0; box-shadow: 0 9px 22px rgba(45,72,56,.06); }.result-link { display: block; padding: 20px 130px 20px 22px; }.result-path { color: #809086; font-size: 11px; }.result-path span { margin: 0 5px; color: #bdc7c0; }.result-card h2 { margin: 7px 0; font-size: 18px; }.result-card p { margin: 0; color: #65746b; font-size: 13px; line-height: 1.75; }.result-card :deep(mark) { border-radius: 2px; padding: 0 2px; background: #f7e4b8; color: #593d1c; }.open { position: absolute; top: 50%; right: 105px; transform: translateY(-50%); color: #6b8d78; }
.favorite-button { position: absolute; top: 50%; right: 16px; transform: translateY(-50%); border: 1px solid #d7e1d9; border-radius: 999px; padding: 7px 10px; background: #f8faf8; color: #617267; cursor: pointer; font-size: 11px; white-space: nowrap; }.favorite-button:hover, .favorite-button.active { border-color: #cba66a; background: #fff8e8; color: #916126; }
...
@media (max-width: 580px) { main { padding-top: 45px; }.search-intro h1 { font-size: 34px; }.result-link { padding: 18px 17px 58px; }.result-card p { display: -webkit-box; overflow: hidden; -webkit-line-clamp: 3; -webkit-box-orient: vertical; }.open { display: none; }.favorite-button { top: auto; right: 14px; bottom: 13px; transform: none; } }
</style>
